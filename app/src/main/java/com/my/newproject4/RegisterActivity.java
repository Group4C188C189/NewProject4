...
public class RegisterActivity extends Activity {
	...
	// private SharedPreferences file; ito yun need na datatype para magana si sharedpreferences
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		// file ito yung variable na maiistore yun sharedprefrences
		...
		register_btn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				file.edit().putString("name", name.getText().toString()).commit();
				file.edit().putString("username", username_register.getText().toString()).commit();
				file.edit().putString("password", password_register.getText().toString()).commit();
